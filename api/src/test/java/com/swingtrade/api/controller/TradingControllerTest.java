...
class TradingControllerTest {
    ...
    @Test
    void testCreatePosition_WithServerError_ReturnsInternalServerError() throws Exception {
        TradeRequest request = createTradeRequest();
        request.setSymbol("SERVER_ERROR");
    ...
    @Test
    void testGetOpenPositions_WithServerError_ReturnsInternalServerError() throws Exception {
        mockMvc.perform(get("/api/trades")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isInternalServerError());
    }
    ...
    void testGetPosition_WithServerError_ReturnsInternalServerError() throws Exception {
        mockMvc.perform(get("/api/trades/SERVER_ERROR")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isInternalServerError());
    }
    ...
    void testClosePosition_WithServerError_ReturnsInternalServerError() throws Exception {
        mockMvc.perform(post("/api/trades/SERVER_ERROR/close")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{}"))
                .andExpect(status().isInternalServerError());
    }
