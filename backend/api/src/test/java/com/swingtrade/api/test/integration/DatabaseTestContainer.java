...
public class DatabaseTestContainer {
    ...
    private static final String TIMESCALE_VERSION = "timescale/timescaledb:latest-pg16";
    ...
    private static final PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>(TIMESCALE_VERSION)
