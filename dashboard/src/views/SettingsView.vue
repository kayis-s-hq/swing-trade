...
const testLlmConnection = async () => {
  ...
  try {
    ...
    if (ok) {
      toastMessage.value = 'LLM settings saved. Test analysis will run on next signal.'
      toastType.value = 'success'
      toastVisible.value = true
      setTimeout(() => {
        toastVisible.value = false
      ...
      toastMessage.value = 'Failed to save LLM settings.'
      toastType.value = 'error'
      toastVisible.value = true
      setTimeout(() => {
        toastVisible.value = false
    ...
    toastMessage.value = err instanceof Error ? err.message : 'Failed to save LLM settings'
    toastType.value = 'error'
    toastVisible.value = true
    setTimeout(() => {
      toastVisible.value = false
