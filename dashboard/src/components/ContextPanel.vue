...
const agreementText = computed(() => {
  ...
  if (props.signal.direction === 'BUY' && sentimentMatchesSell) return 'Conflicts — bearish sentiment vs buy signal'
  if (props.signal.direction === 'SELL' && sentimentMatchesBuy) return 'Conflicts — bullish sentiment vs sell signal'
