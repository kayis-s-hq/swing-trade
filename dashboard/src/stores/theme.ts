...
export const useThemeStore = defineStore('theme', () => {
  ...
  watch(isDark, (dark) => {
    ...
    document.documentElement.style.setProperty('--color-bg-elevated', dark ? '#1c2030' : '#ffffff')
    ...
    document.documentElement.style.setProperty('--color-border-subtle', dark ? '#252a3a' : '#d1d5db')
    document.documentElement.style.setProperty('--color-border-default', dark ? '#323850' : '#9ca3af')
    ...
    document.documentElement.style.setProperty('--color-success-bg', dark ? 'rgba(0, 212, 160, 0.1)' : 'rgba(0, 212, 160, 0.12)')
    document.documentElement.style.setProperty('--color-danger-bg', dark ? 'rgba(255, 77, 106, 0.1)' : 'rgba(255, 77, 106, 0.12)')
    document.documentElement.style.setProperty('--color-info-bg', dark ? 'rgba(77, 154, 255, 0.1)' : 'rgba(77, 154, 255, 0.12)')
  }, { immediate: true })
