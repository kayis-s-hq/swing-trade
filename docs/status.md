...
- [x] Broker coverage remediation completed 2026-09-17: risk-control orchestration,
  ...
  existing aggregate coverage is 40% (1,555/3,885 lines) against the 80% gate; focused
  WatchlistService, DataIngestionService, and TradeLabelService coverage was added, but this
  remains the next full-build blocker. The data PMD test violation was also removed and the
  scoped verifier passed.
